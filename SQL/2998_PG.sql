...
Esquema
clients
Coluna	Tipo	id (PK)	integer	name	varchar (50)	investment	numeric  
operations
Coluna	Tipo	id (PK)	integer	client_id (FK)	integer	month	integer	profit	numeric
Tabelas
clients
id	name	investment	1	Daniel	500	2	Oliveira	2000	3	Lucas	1000  
operations
id	client_id	month	profit	1	1	1	230	2	2	1	1000	3	2	2	1000	4	3	1	100	5	3	2	300	6	3	3	900	7	3	4	400
Exemplo de saída
name	investment	month_of_payback	return	Lucas	1000	3	300	Oliveira	2000	2	0